...
Twenty-three operations work: seventeen reads and six writes - sending text, marking a chat read, changing a lot price, raising offers, and activating or deactivating a lot.
