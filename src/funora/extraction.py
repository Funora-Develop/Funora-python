r"""Словари извлечения: статусы заказа и присутствие контрагента.
...
SELECTORS: Final[dict[str, str]] = {
    ...
    "catalog.game.title": ".promo-game-item > .game-title",
    "catalog.game.title.within_card": ".game-title",
    "catalog.lists.catalog": "div.promo-games.promo-games-all",
    ...
    "catalog.totality.alphabet_index": "nav.nav-abc",
    ...
    "market.fields.price_text": ".tc-price > div",
    "market.fields.seller_link": ".avatar-photo",
    "market.fields.seller_name": ".media-user-name",
    "market.fields.server_text": ".tc-server",
    "market.markers.online": "a.tc-item",
    "market.rows": "a.tc-item",
    "market.seller_trap": "a.tc-item",
    ...
    "order.refund.form": "form[action$='/orders/refund']",
    ...
    "session.identity.app_data": "body[data-app-data]",
    "session.identity.own_profile_link": "a.user-link-dropdown",
    "session.identity.own_user_id": "[data-user]",
    "session.identity.own_username": ".user-link-name",
...
ATTRIBUTES: Final[dict[str, str]] = {
    ...
    "catalog.sections.list.attributes.belongs_to": "data-id",
    ...
    "lots.rows.attributes.offer_href": "href",
    "lots.rows.attributes.offer_id": "data-offer",
    "market.fields.price_cell.attributes.sort_value": "data-s",
    "market.fields.seller_link.attributes.seller_href": "data-href",
    ...
    "session.identity.app_data.attributes.app_data": "data-app-data",
    "session.identity.own_profile_link.attributes.own_profile_href": "href",
    "session.identity.own_user_id.attributes.own_user_id": "data-user",
