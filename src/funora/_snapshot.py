...
видно, что появилось, что пропало и у чего сменилась цена. Наблюдения и события
порождает monitoring.watch, который хранит историю и подтверждения доставки.
"""
