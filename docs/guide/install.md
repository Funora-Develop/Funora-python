...
Следующие команды относятся к текущей версии разработки `0.0.1.dev2`;
в исходниках тега pre-alpha используется его закреплённая версия контракта.

Для полного прогона нужна соседняя рабочая копия `Funora-spec` версии `0.60.0`.
CI закреплён на ревизии `526a3a47d6f54d500c7671c2426c80f95f6dbbcf`.
