...
Контракт в состоянии `draft` и меняется. Тестовый pre-alpha `0.0.1.dev1`
распространяется через GitHub: [установка и ограничения](pre-alpha.md).
Выпущенного пакета на PyPI нет.
