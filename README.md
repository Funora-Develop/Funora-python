...
Работают четырнадцать операций: тринадцать чтения и одна записи - отправка текста.
...
Операция записи одна - отправка текста, и у неё [своя глава в
руководстве](docs/guide/sending.md): исходов у отправки три, а не два, и третий -
«неизвестно» - это то, ради чего глава написана.
...
Отправка изображения, отметка прочитанным и четыре операции записи над лотами
объявлены контрактом и не написаны: запросов, которыми площадка их делает, никто
