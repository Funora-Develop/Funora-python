...
Работают двадцать девять операций: девятнадцать чтения и десять записи - отправка текста и картинки, отметка прочтения, отзыв и его снятие, правка цены лота, поднятие предложений, включение и выключение лота.
