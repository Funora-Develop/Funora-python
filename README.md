...
Схема полей раздела, история операций счёта, лента событий заказа и язык
интерфейса объявлены контрактом и не написаны: запросов, которыми площадка их
делает, никто не наблюдал. Позвав их, вы получите
`NotImplementedOperationError` - отказ самой Funora, а не встроенную ошибку
Python.
