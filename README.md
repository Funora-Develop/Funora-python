...
Работают восемнадцать операций: шестнадцать чтения и две записи - отправка текста и правка цены лота.
...
раздела, снимок рынка и три операции записи над лотами - включение, выключение и
поднятие - объявлены контрактом и не написаны: запросов, которыми площадка их
