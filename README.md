...
Работают двадцать четыре операции: семнадцать чтения и семь записи - отправка текста и картинки, отметка прочтения, правка цены лота, поднятие предложений, включение и выключение лота.
