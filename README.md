...
Работают двадцать три операции: семнадцать чтения и шесть записи - отправка текста, отметка прочтения, правка цены лота, поднятие предложений, включение и выключение лота.
