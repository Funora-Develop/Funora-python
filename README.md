...
Работают двадцать шесть операций: семнадцать чтения и девять записи - отправка текста и картинки, отметка прочтения, отзыв и его снятие, правка цены лота, поднятие предложений, включение и выключение лота.
