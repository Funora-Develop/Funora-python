...
Работают тридцать три операции: двадцать две чтения и одиннадцать записи - отправка текста и картинки, отметка прочтения, отзыв и его снятие, правка цены лота, поднятие предложений, включение и выключение лота.
